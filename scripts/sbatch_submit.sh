...
python scripts/cell_segmentation_pipeline.py -t single -ri spatial3 -si B2 -fm DAPI -nt xenium_test_resolve

pid=$!
wait $pid
echo Moving logfile
mv /projects/cbmr_shared/people/wqc597/neuronal_projection_classifier/processed_data/segmentation_logs/"$SLURM_JOB_ID"_segmentation_inner8.log /projects/cbmr_shared/people/wqc597/neuronal_projection_classifier/processed_data/B2_cell_seg_xenium_test_resolve.log
